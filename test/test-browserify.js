...
function _main() {
    ...
    function logger(logStream) {
        ...
        var chalkStyles = {
            h1: (m) => chalk.bold.red(m),
            h2: (m) => chalk.bold.blue(m),
            h3: (m) => chalk.bold.yellow(m),
            h4: (m) => chalk.yellow.underline(m),
            crazy: (m) => m
        };
        ...
        var cssStyles = {
            ...
            h4: (m) => [`%c${m}`, `text-decoration: underline; color: ${cssYellow}`],
            crazy: (m) => [`%c${m}`, cssCrazy]
        };

        return StyleLogger(
            logStream,
            typeof window !== 'undefined' && !!navigator.userAgent.match(/(?=Chrome)|(?=Firefox)/) ? cssStyles : chalkStyles,
...
function firebug(loaded) {
    var s = document.createElement('script');
    s.src = '../firebug-lite/build/firebug-lite.js';
